...
public class MovieCellWatchlist extends ListCell<Movie> {
    ...
    private final Button watchlist = new Button("Remove from Watchlist");
    private final VBox layout = new VBox(title, detail, genres,releaseyear,rating, watchlist);

    public MovieCellWatchlist() {}
    public MovieCellWatchlist(ClickEventHandler removefromWatchlist) {
        super();
    ...
    protected void updateItem(Movie movie, boolean empty) {
        ...
        if (empty || movie == null) {
            ...
            watchlist.getStyleClass().add("background-yellow");
